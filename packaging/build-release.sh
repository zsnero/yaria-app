...
echo ""
echo "Server directory structure (updater expects these names):"
echo "  yaria.live/download/"
echo "    ├── latest.txt"
echo "    ├── yaria-app-linux-amd64.tar.gz"
echo "    ├── yaria-app-linux-arm64.tar.gz"
echo "    ├── yaria-app-windows-amd64.zip   (binary: yaria-app.exe)"
echo "    ├── yaria-app-darwin-amd64.tar.gz"
echo "    ├── yaria-app-darwin-arm64.tar.gz"
...
echo "        └── yaria-256.png"
echo ""
echo "Windows package: zip containing yaria-app.exe (WebView2 Runtime required on target)."
echo "macOS package: tar.gz containing yaria-app binary (build on macOS recommended)."
echo ""
