...
func (m *MediaService) GetNextEpisode(id string) map[string]interface{}       { return map[string]interface{}{} }
func (m *MediaService) PlayPath(filePath string) map[string]interface{}       { return map[string]interface{}{"error": stubErr} }
